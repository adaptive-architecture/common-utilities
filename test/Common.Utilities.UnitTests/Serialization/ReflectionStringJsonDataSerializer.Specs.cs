...
public class ReflectionStringJsonDataSerializerSpecs
{
    private readonly ReflectionStringJsonDataSerializer _serializer;

    public ReflectionStringJsonDataSerializerSpecs()
    {
        _serializer = new ReflectionStringJsonDataSerializer();
    }
    ...
    {
        // Act
        var serializer = new ReflectionStringJsonDataSerializer(null);
    ...
    public void Constructor_WithCustomOptions_ShouldUseProvidedOptions()
    {
        ...
        // Act
        var serializer = new ReflectionStringJsonDataSerializer(customOptions);
